...
@property (nonatomic) _Bool m_bNew;

@property (nonatomic) _Bool m_bFolded;
...
- (void)setProvideLocationSwitch:(_Bool)_switch;
...
@interface VoIPPushService : MMRootService {
    /* instance variables */
    NSData *m_token;
}
...
@interface VOIPMessageMgr : MMUserService {
